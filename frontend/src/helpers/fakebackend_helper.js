...
// User Profile
export const get_Profile=()=> api.get(url.GET_PROFILE)
export const postProfile = (data) => api.create(url.EDIT_PROFILE, data);//edit profile naam change krne me bahut jagah krna padega

//Org Profile
export const get_Orgprofile=()=> api.get(url.Get_Org_Profile);
export const get_Countries=()=> api.get(url.GetCountries)

//change profile
export const Change_password=(password)=> api.create(url.changepswrd,password)

//save email preferences
export const save_user_email_preferences=(data)=> api.create(url.save_email_preferences,data)
