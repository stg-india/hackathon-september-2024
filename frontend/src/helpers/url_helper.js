//REGISTER
export const POST_FAKE_REGISTER = "/customer/register_first_step/";

//LOGIN
export const POST_FAKE_LOGIN = "/common/login/";
// export const POST_FAKE_LOGIN = "/auth/signin";
export const POST_FAKE_JWT_LOGIN = "/post-jwt-login";
export const POST_FAKE_PASSWORD_FORGET = "password_reset/";
...
export const GET_PROFILE = "/common/get_profile/";
export const EDIT_PROFILE = "/common/update_profile/";
export const Get_Org_Profile="/customer/get_customer/";
export const GetCountries="/global_data/get_all_countries/";
export const changepswrd="/common/change_password/";
export const save_email_preferences="customer/save_user_email_preferences/";
